...
class _HealthConditionsScreenState extends State<HealthConditionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.dark, // 배경이 밝으므로 어두운 아이콘
      child: Scaffold(
            ...
            Container(
              ...
              child: _isLoading
                  ...
                  : SafeArea(
                      ...
                      top: false, // 상단 SafeArea는 직접 처리
                      bottom: false, // 하단은 bottomNavigationBar에서 처리
                      child: Padding(
                        // 상태 표시줄 + AppBar 높이만큼 상단 패딩 추가
                        padding: EdgeInsets.only(top: statusBarHeight + appBarHeight),
                        child: Column(
                          children: [
                            // 상단 안내 카드
                            Container(
                              margin: const EdgeInsets.fromLTRB(16, 0, 16, 8), // 상단 마진 제거
